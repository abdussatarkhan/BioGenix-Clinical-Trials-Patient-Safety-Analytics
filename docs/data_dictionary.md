...
## 🏢 Platform: BioGenix: Global Biopharma Phase-III Clinical Trials & Patient Safety Analytics
**Schema**: `biogenix_dw`  
...
### 2. `dim_trials`
Dimensional attribute master for Trials.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `trials_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `trials_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
...
### 2. `dim_trial_sites`
Dimensional attribute master for Trial Sites.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `trial_sites_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `trial_sites_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |

### 2. `dim_patients_cohort`
Dimensional attribute master for Patients Cohort.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `patients_cohort_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `patients_cohort_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |

### 2. `dim_adverse_event_codes`
Dimensional attribute master for Adverse Event Codes.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `adverse_event_codes_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `adverse_event_codes_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### `fact_patient_visits`
Transactional and snapshot grain telemetry table tracking Patient Visits.
...
### `fact_adverse_events_sae`
Transactional and snapshot grain telemetry table tracking Adverse Events Sae.
...
### `fact_protocol_deviations`
Transactional and snapshot grain telemetry table tracking Protocol Deviations.
...
### `fact_drug_dispensation`
Transactional and snapshot grain telemetry table tracking Drug Dispensation.
