"""
BioGenix: Global Biopharma Phase-III Clinical Trials & Patient Safety Analytics - Synthetic Telemetry Data Generator
"""
import argparse
import datetime
import os
...
def generate_dataset(n_records=10000, output_dir="data"):
    ...
    print(f"Generating {n_records} records for BioGenix-Clinical-Trials-Patient-Safety-Analytics...")
    records = []
